...
class LinePlotTestCase(unittest.TestCase):
    ...
    def test_line_plot_title(self):
        ...
        self.assertEqual(
            actual, expected, "Expected line plot title to be 'Daily freeCodeCamp Forum Page Views 5/2016-12/2019'")
...
class BoxPlotTestCase(unittest.TestCase):
    ...
    def test_box_plot_labels(self):
        ...
        expected = "Month"
        self.assertEqual(actual, expected,
                         "Expected box plot 2 xlabel to be 'Month'")
        actual = self.ax2.get_ylabel()
        expected = "Page Views"
        self.assertEqual(actual, expected,
                         "Expected box plot 2 ylabel to be 'Page Views'")
        actual = []
    ...
    def test_box_plot_titles(self):
        ...
        self.assertEqual(
            actual, expected, "Expected box plot 2 title to be 'Month-wise Box Plot (Seasonality)'")
